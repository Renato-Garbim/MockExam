...
{
    public abstract class RabbitMQBaseClass : IDisposable
    {
        ...
        private readonly ILogger<RabbitMQBaseClass> _logger;

        protected RabbitMQBaseClass(ConnectionFactory connectionFactory, ILogger<RabbitMQBaseClass> logger)
        {
