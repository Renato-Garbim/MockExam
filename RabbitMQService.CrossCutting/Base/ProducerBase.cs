...
{
    public abstract class ProducerBase<T> : RabbitMQBaseClass, IRabbitMqProducer<T>
    {
        ...
        public ProducerBase(ConnectionFactory connectionFactory, ILogger<RabbitMQBaseClass> logger, ILogger<ProducerBase<T>> producerBaseLogger) : base(connectionFactory, logger)
